 ...
 *
 * This module manages the YAML-based collection configuration at ~/.config/qmd-org/index.yml.
 ...
 * Config file will be ~/.config/qmd-org/{indexName}.yml
 */
...
function getConfigDir(): string {
  ...
  if (process.env.XDG_CONFIG_HOME) {
    return join(process.env.XDG_CONFIG_HOME, "qmd-org");
  }
  return join(homedir(), ".config", "qmd-org");
}
 ...
 * - File-based: reads from YAML file (default ~/.config/qmd-org/index.yml)
 ...
 * - File-based: writes to YAML file (default ~/.config/qmd-org/index.yml)
 */
